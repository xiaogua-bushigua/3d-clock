...
const Clock = () => {
	...
	return (
		<mesh>
			<Rings speed={15} scale={0.75} thickness={0.65} color={new THREE.Color('white')} />
			<Rings speed={12.5} scale={1.05} thickness={0.35} color={new THREE.Color(0.25, 0.225, 0.215)} />
			<Rings speed={10} scale={1.3} thickness={0.15} color={new THREE.Color(0.7, 0.7, 0.7)} />
